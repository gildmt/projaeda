...
unsigned short int menuInicial(){
	...
	cout << TAB << "4 - Consultar Transacoes efetuadas por clientes." << endl;
	cout << TAB << "5 - Consultar Transacoes efetuadas por titulo." << endl;
	cout << TAB << "6 - Consultar Transacoes efetuadas por data." << endl;
...
void opcoesIniciais(Bolsa & bolsa_de_valores){
	...
	while ((opcao = menuInicial()))
		...
		case 5:  bolsa_de_valores.listar_transacoes_titulo();
			break;
		case 6: bolsa_de_valores.listar_transacoes_intervalo_de_tempo();
			break;
